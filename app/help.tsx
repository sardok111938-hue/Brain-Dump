import { SafeAreaView, Text, StyleSheet, ScrollView, View, Pressable } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.privacyCard}>
          ...
          <Text style={styles.privacyText}>
            When you tap “Organize” or use Speak, your words are sent securely to an AI service to turn them into suggestions.
          </Text>

          <Text style={styles.privacyText}>
            We don’t store your entries or recordings ourselves, and you can clear your data anytime.
          </Text>
        </View>
